...
{
    // Fungsi untuk memutar arah kamera kiri/kanan
    lx = sin(ang / 10);
    lz = -cos(ang / 10);
...
{
    // Fungsi dijalankan saat tombol keyboard ditekan dan belum dilepas
...
{
    // Fungsi dijalankan saat tombol keyboard dilepas
...
// Kondisi yang mengubah nilai putaran kaki
void pergerakanKaki()
{
...
void pergerakanBola()
{
    ...
    if (roll == 1)
    {
        if (jarak > 0)
        {
            posXBola -= 0.03f; // Mengatur kecepatan dan jarak tempuh bola
            jarak -= 0.01f;    // Mengatur banyaknya perulangan
        }
